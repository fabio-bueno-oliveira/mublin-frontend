...
import { Grid, Container, Modal, Checkbox, Center, Group, Flex, Alert, Loader, Input, Image, NativeSelect, Button, Radio, Text, Breadcrumbs, Anchor, TextInput } from '@mantine/core'
            ...
            {user.requesting ? (
              ...
              <>
                ...
                <Alert mb={16} variant="light" color="yellow">
                  Envie um arquivo de até 2mb. A foto do produto deve ser genérica e com qualidade, de preferência em estado de novo. A foto deve ter aproximadamente 22 pixels de margem em cada extremidade (independente da largura ou altura), e fundo branco ou transparente. De prefência, de frente sem inclinação.<strong>Uma vez cadastrado, o produto não poderá ter a foto substituída!</strong>
                </Alert>
                <Center>
