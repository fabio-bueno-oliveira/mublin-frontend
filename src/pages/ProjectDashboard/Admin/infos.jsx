...
import { useMantineColorScheme, Grid, Group, Box, Card, Center, Flex, Title, Text, Image, Skeleton, Avatar, Loader, Indicator, Drawer, Button, TextInput, NativeSelect, em } from '@mantine/core'
import { useDisclosure, useMediaQuery, useFetch } from '@mantine/hooks'
import { useForm, isNotEmpty, isEmail, hasLength } from '@mantine/form'
import { notifications } from '@mantine/notifications'
import { IconBrandInstagram, IconMenu2, IconPlus, IconTrash } from '@tabler/icons-react'
      ...
      <Grid id='dashboard' gutter={0}>
        <Grid.Col span={{ base: 12, md: 2.5, lg: 2.5 }} id='desktopSidebar' p={14}>
          ...
          <Box className='showOnlyInLargeScreen'>
            <Navbar desktop page='adminInfo' adminPages={true} />
          </Box>
        </Grid.Col>
                  ...
                  <Box pos='relative' p={10}>
                    ...
                    <Grid>
                      <Grid.Col span={6}>
                        ...
                        >
                          <option value='2'>Autoral</option>
                          <option value='3'>Cover</option>
                          <option value='1'>Autoral + Cover</option>
                        </NativeSelect>
                      </Grid.Col>
                      <Grid.Col span={6}>
                        <NativeSelect
