...
import { Container, Flex, Grid, Affix, Space, Transition, Paper, Center, Stack, Title, Text, Anchor, Image, NativeSelect, Group, Avatar, Box, Skeleton, SimpleGrid, useMantineColorScheme, Modal, Button, Badge, ScrollArea, Alert, Tooltip, Divider, ActionIcon, Accordion, Indicator, rem, em } from '@mantine/core';
import { useWindowScroll } from '@mantine/hooks';
import { IconCircleFilled, IconCheck, IconShieldCheckFilled, IconRosetteDiscountCheckFilled, IconStar, IconStarFilled, IconBrandInstagram, IconMail, IconChevronDown, IconLink, IconLockSquareRoundedFilled } from '@tabler/icons-react';
                  ...
                  <Grid>
                    <Grid.Col span={{ base: 12, md: 6, lg: 6 }}>
                      ...
                      <Group gap={12} mt={largeScreen ? 12 : 11} mb={largeScreen ? 10 : 9}>
                        ...
                        >
                          <span style={{fontWeight:'500'}}>{profile.followers.length}</span> seguidores
                        </Text>
                        <Text 
                          className='point' 
                          size={largeScreen ? '0.9rem' : '14px'} 
                          ...
                          style={{lineHeight: 'normal'}}
                        >
                          <span style={{fontWeight:'500'}}>{profile.following.length}</span> seguindo
                        </Text>
                      </Group>
                        ...
                        <>
                          ...
                          {largeScreen && 
                            <Box>
                              ...
                              <Text size="0.85em" fw={400} mb={2} mt={7}>
                                Tipos de projetos:
                              </Text>
                              <Group gap={4}>
                                {profile.requesting ? (
              ...
              {isMobile && 
                <Box mb={18}>
                  <Group justify="flex-start" align="center" mb={18}>
                    <Title order={4} fw={600}>Projetos ({profile?.projects?.length})</Title>
                  </Group>
                  {profile.requesting ? ( 
                      <Text size='sm'>Carregando...</Text>
                  ) : (
              ...
              {profile.plan === "Pro" ? ( 
                ...
                <>
                  {user.id === profile.id && 
                    ...
                    >
                      <Group gap={2} mb={8}>
                        <Title order={4} fw={500}>Equipamento</Title>
                        <IconLockSquareRoundedFilled size={24} color="gray" /> 
                      </Group>
                      <Text size="sm">
                              ...
                              <Flex gap={10} mb={10}>
                                ...
                                >
                                  <Box w={120}>
                                    ...
                                    <Text size='14px' fw={500} mb={3} truncate="end" title={project.name}>
