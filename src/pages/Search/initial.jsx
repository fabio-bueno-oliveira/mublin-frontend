...
import { Container, Grid, Group, Flex, Title, Text, Anchor, Avatar, Image, Input, CloseButton, rem, em } from '@mantine/core';
        ...
        {(searchedKeywords && !searchResults.requesting) && 
          <Grid>
            <Grid.Col span={{ base: 12, md: 4, lg: 4 }} pr={10}>
              <Title order={5} fw={650} mb={14}>{`Pessoas (${searchResults.users.total})`}</Title>
            ...
            <Grid.Col span={{ base: 12, md: 4, lg: 4 }}>
              ...
              {searchResults.gear.total ? 
                ...
                ) : (<Text size='sm' c='dimmed'>Nenhum equipamento encontrado</Text>)
              }
            </Grid.Col>
          </Grid>
        }
