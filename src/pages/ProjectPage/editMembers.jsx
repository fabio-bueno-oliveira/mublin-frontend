...
import { Group, Box, Card, Center, Flex, Title, Text, Image, Skeleton, Avatar, Loader, Button, Badge, Table, rem, Modal, NativeSelect, Alert, Divider } from '@mantine/core'
import { IconCheck, IconX, IconRosetteDiscountCheckFilled, IconShieldCheckFilled, IconDotsVertical } from '@tabler/icons-react'

function ProjectDashboardAdminTeamPage () {
        ...
        {memberInfo.map(memberToManage => 
          <Box key={memberToManage.id}>
            ...
            <NativeSelect
              ...
              disabled={(!project.loggedUserIsAdmin ? true : false || (membersAdmin.length < 2 && memberToManage.id === user.id))}
              onChange={(e) => 
            ...
            {!!(membersAdmin.length === 1 && project.loggedUserIsAdmin && user.id === memberToManage.id) && 
              <Text size='xs' fw={500}>
            ...
            {(memberToManage.id === user.id) && 
              <>
                ...
                <Button 
                  ...
                  color='red' 
                  mt={4} 
                  disabled={(membersAdmin.length === 1 && project.loggedUserIsAdmin) ? true : false}
                  onClick={() => updateMemberSettings(memberToManage.id)}
                >
            ...
            {!!(membersAdmin.length === 1 && project.loggedUserIsAdmin && memberToManage.id === user.id) && 
              <Text size='xs' mt={4}>
...
export default ProjectDashboardAdminTeamPage